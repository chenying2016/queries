...
/// chaining scoring options
const string kArgMemScKmerSize("cs_kmer_size");
const int kDfltMemScKmerSize = 5;
const int kMemScKmerSizeMin = 2;
const int kMemScKmerSizeMax = 10;
const string kArgMemScKmerWindow("memsc_kmer_window");
const int kDfltMemScKmerWindow = 1;
const string kArgMemScMemScore("memsc_mem_score");
const int kDfltMemScMemScore = 5;
...
const int kDfltMaxHSPsPerSubject = 100;
...
s_PreCheckCmdLineArgs(int argc, char* argv[], CArgDescriptions* arg_desc)
{
    ...
    string kHbnUsage = kProgram + " [OPTIONS] primer query";
