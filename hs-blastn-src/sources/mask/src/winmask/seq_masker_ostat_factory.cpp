/*  $Id: seq_masker_ostat_factory.cpp 434184 2014-05-05 14:32:02Z morgulis $
 * ===========================================================================
 *
...
#include "seq_masker_ostat_ascii.hpp"
#include "seq_masker_ostat_bin.hpp"
    ...
    string const & metadata )
{
    //try
    {
        ...
        else 
		{
			...
			const char* err = "unkown unit counts format";
			error_and_exit(err);
		}
    }
    //catch( CException & e ) {
