/* $Id: blast_hits.h 573792 2018-11-01 15:47:14Z ivanov $
 * ===========================================================================
 *
...
#ifndef SBlastTargetTranslation
...
typedef struct {
   SmallObjectAlloc* ges_alloc;
   HbnGapEditScript* recyclable_ges_list;
...
typedef struct {
   ...
   int gaps;
   int gap_opens;
   size_t query_align_offset;
   size_t subject_align_offset;
} HbnHSPInfo;
...
typedef struct BlastHSP {
   ...
   HbnSeg hbn_query; /**< query sequence info. */
   HbnSeg hbn_subject; /**< subject sequence info. */
   HbnGapEditScript* hbn_gap_info; /**< gapped alignment. */
   HbnHSPInfo hsp_info;
} BlastHSP;

typedef kvec_t(BlastHSP) vec_blasthsp;

void ks_introsort_blasthsp_score_gt(size_t n, BlastHSP* a);

void ks_introsort_blasthsp_identity_gt(size_t, BlastHSP* a);

void ks_introsort_blasthsp_align_length_gt(size_t n, BlastHSP* a);
...
void
HbnHSPResultsStat(HbnHSPResults* results);
