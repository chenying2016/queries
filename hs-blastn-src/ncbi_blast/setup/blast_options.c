/* $Id: blast_options.c 567495 2018-07-19 13:19:39Z fongah2 $
 * ===========================================================================
 *
...
extern Boolean BLAST_CheckRewardPenaltyScores(Int4 reward, Int4 penalty);

extern Int2 Blast_KarlinBlkGappedLoadFromTables(Blast_KarlinBlk* kbp, Int4 gap_open, Int4 gap_extend, const char* matrix_name, Boolean standard_only);
