...
//                       false otherwise
//            */
//            virtual bool find( const CBioseq_Handle & bsh ) const = 0;
//    };
...
//            */
//            virtual bool find( const CBioseq_Handle & ) const;
...
//        const CBioseq_Handle& operator* (void) const { return m_CurrentBioseq; }
//        const CBioseq_Handle* operator-> (void) const { return &m_CurrentBioseq; }
